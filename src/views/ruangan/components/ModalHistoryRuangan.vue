<template>
  <BaseModal
    ...
    id="modal_history_ruangan"
    :showFooter="false"
  >
    <h3 class="text-center mb-1">History Ruangan</h3>
    <p class="text-center">Detail History Ruangan yang telah disimpan</p>
    ...
    <div class="row mb-2 mt-2">
      ...
      <div class="col-md-12 mt-2">
        <label class="form-label" for="selected-ruangan">Ruangan</label>

        <select
          id="selected-ruangan"
          name="selected-ruangan"
          class="form-select"
          v-model="pk"
        >
      ...
      <div class="col-md-12">
        <div class="table-responsive">
          <v-table
            ...
            :data="list_history_ruangan.data"
          ...
          >
            ...
            <tbody slot="body" slot-scope="{ displayData }">
              <tr v-if="list_history_ruangan.loading">
                <td colspan="2" class="text-center">Loading...</td>
              </tr>

              <tr
                v-else-if="!list_history_ruangan.loading && displayData.length"
                      ...
                      >
                        <div class="d-flex flex-column">
                          ...
                          >
                            ...
                            {{
                              documentParsed(item?.before)?.ruangan ||
                              documentParsed(item?.after)?.ruangan
                            }}
                          </h5>
                          <div class="d-flex">
                            <div>
              ...
              <tr v-else>
                <td colspan="2" class="text-center">
                  Tidak ada History Ruangan ditemukan
                </td>
              </tr>
            </tbody>
          </v-table>
        ...
        <CustomPagination
          v-if="
            !list_history_ruangan.loading && list_history_ruangan.data.length
          "
          :currentDataLength="list_history_ruangan.data.length"
          :totalData="meta.total"
        >
          <template #page>
            <smart-pagination
              v-if="list_history_ruangan.data"
...
export default {
  ...
  methods: {
    ...
    async getListHistoryRuangan({ limit, offset, from, to, created_by, pk }) {
      try {
        this.list_history_ruangan.loading = true;
        ...
        if (response) {
          this.list_history_ruangan.loading = false;
          this.list_history_ruangan.data = response?.data?.rows;
          this.meta = {
