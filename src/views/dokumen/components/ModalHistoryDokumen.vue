<template>
  <BaseModal
    ...
    id="modal_history_dokumen"
    :showFooter="false"
  >
    <h3 class="text-center mb-1">History Dokumen</h3>
    <p class="text-center">Detail History Dokumen yang telah disimpan</p>
    ...
    <div class="row mb-2 mt-2">
      ...
      <div class="col-md-6">
       ...
       <div class="col-md-12 mt-2">
        <label class="form-label" for="selected-document">Dokumen</label>
        ...
        >
          ...
          <option
            v-for="(item, index) in listDokumen"
      ...
      <div class="col-md-12">
        <div class="table-responsive">
          <v-table
            ...
            :data="list_history_dokumen.data"
          ...
          >
            ...
            <tbody slot="body" slot-scope="{ displayData }">
              <tr v-if="list_history_dokumen.loading">
                <td colspan="2" class="text-center">Loading...</td>
              </tr>

              <tr
                v-else-if="!list_history_dokumen.loading && displayData.length"
                      ...
                      >
                        <div class="d-flex flex-column">
                          ...
                          >
                            ...
                            {{
                              documentParsed(item?.before)?.document ||
                              documentParsed(item?.after)?.document
                            }}
                          </h5>
                          <div class="d-flex">
                            <div>
              ...
              <tr v-else>
                <td colspan="2" class="text-center">
                  Tidak ada History Dokumen ditemukan
                </td>
              </tr>
            </tbody>
          </v-table>
        ...
        <CustomPagination
          v-if="
            !list_history_dokumen.loading && list_history_dokumen.data.length
          "
          :currentDataLength="list_history_dokumen.data.length"
          :totalData="meta.total"
        >
          <template #page>
            <smart-pagination
              v-if="list_history_dokumen.data"
...
export default {
  ...
  methods: {
    ...
    async getListHistoryDokumen({ limit, offset, from, to, created_by, pk }) {
      try {
        this.list_history_dokumen.loading = true;
        ...
        if (response) {
          this.list_history_dokumen.loading = false;
          this.list_history_dokumen.data = response?.data?.rows;
          this.meta = {
