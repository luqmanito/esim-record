<template>
  <BaseModal
    ...
    id="modal_history_box_dimension"
    :showFooter="false"
  >
    <h3 class="text-center mb-1">History Box Dimensi</h3>
    <p class="text-center">Detail History Box Dimensi yang telah disimpan</p>
    ...
    <div class="row mb-2 mt-2">
      ...
      <div class="col-md-12 mt-2">
        <label class="form-label" for="selected-box-dimension"
          >Box Dimensi</label
        >

        <select
          id="selected-box-dimension"
          name="selected-box-dimension"
          class="form-select"
          v-model="pk"
        >
          <option value="">Semua Box Dimensi</option>
          <option
      ...
      <div class="col-md-12">
        <div class="table-responsive">
          <v-table
            ...
            :data="list_history_box_dimension.data"
          ...
          >
            ...
            <tbody slot="body" slot-scope="{ displayData }">
              <tr v-if="list_history_box_dimension.loading">
                <td colspan="2" class="text-center">Loading...</td>
              </tr>

              <tr
                v-else-if="
                  !list_history_box_dimension.loading && displayData.length
                "
                      ...
                      >
                        <div class="d-flex flex-column">
                          ...
                          >
                            ...
                            {{
                              documentParsed(item?.before)?.box ||
                              documentParsed(item?.after)?.box
                            }}
                          </h5>
                          <div class="d-flex">
                            <div>
              ...
              <tr v-else>
                <td colspan="2" class="text-center">
                  Tidak ada History Box Dimensi ditemukan
                </td>
              </tr>
            </tbody>
          </v-table>
        ...
        <CustomPagination
          v-if="
            !list_history_box_dimension.loading &&
            list_history_box_dimension.data.length
          "
          :currentDataLength="list_history_box_dimension.data.length"
          :totalData="meta.total"
        >
          <template #page>
            <smart-pagination
              v-if="list_history_box_dimension.data"
...
export default {
  ...
  methods: {
    ...
    async getListHistoryBox({ limit, offset, from, to, created_by, pk }) {
      try {
        this.list_history_box_dimension.loading = true;
        ...
        if (response) {
          this.list_history_box_dimension.loading = false;
          this.list_history_box_dimension.data = response?.data?.rows;
          this.meta = {
