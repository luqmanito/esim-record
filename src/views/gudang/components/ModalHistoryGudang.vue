<template>
  <BaseModal
    ...
    id="modal_history_gudang"
    :showFooter="false"
  >
    <h3 class="text-center mb-1">History Gudang</h3>
    <p class="text-center">Detail History Gudang yang telah disimpan</p>
    ...
    <div class="row mb-2 mt-2">
      ...
      <div class="col-md-12 mt-2">
        <label class="form-label" for="selected-gudang">Layanan</label>

        <select
          id="selected-gudang"
          name="selected-gudang"
          class="form-select"
          v-model="pk"
        >
    ...
    <div class="mt-1">
      <div class="col-md-12">
        <div class="table-responsive">
          ...
          >
            ...
            <tbody slot="body" slot-scope="{ displayData }">
              <tr v-if="list_history_gudang.loading">
                <td colspan="2" class="text-center">Loading...</td>
              </tr>

              <tr
                v-else-if="!list_history_gudang.loading && displayData.length"
                      ...
                      >
                        <div class="d-flex flex-column">
                          ...
                          >
                            ...
                            {{
                              documentParsed(item?.before)?.gudang ||
                              documentParsed(item?.after)?.gudang
                            }}
                          </h5>
                          <div class="d-flex">
                            <div>
              ...
              <tr v-else>
                <td colspan="2" class="text-center">
                  Tidak ada History Gudang ditemukan
                </td>
              </tr>
            </tbody>
          </v-table>
        ...
        <CustomPagination
          v-if="!list_history_gudang.loading && list_history_gudang.data.length"
          :currentDataLength="list_history_gudang.data.length"
          :totalData="meta.total"
        >
          <template #page>
            <smart-pagination
              v-if="list_history_gudang.data"
...
export default {
  ...
  methods: {
    ...
    async getListHistoryGudang({ limit, offset, from, to, created_by, pk }) {
      try {
        this.list_history_gudang.loading = true;
        ...
        if (response) {
          this.list_history_gudang.loading = false;
          this.list_history_gudang.data = response?.data?.rows;
          this.meta = {
